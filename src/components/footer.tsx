            ...
            <div className="max-w-6xl mx-auto px-6 py-14">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
                    ...
                    <div className="space-y-5 md:col-span-1">
                        <Link
                            href="/"
                            className="inline-flex items-center gap-2.5 font-extrabold text-lg tracking-tight"
                        >
                        ...
                        <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                            Platform belajar pemrograman modern untuk developer Indonesia.
                            Kuasai Golang, Next.js, dan cloud computing dengan panduan
                            praktis dan mendalam.
                        </p>

                        <div className="space-y-2 pt-1">
                            <a
                                href="mailto:me@ozan.my.id"
                                className="flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors group"
                            >
                            ...
                            <a
                                href="https://perschat.my.id"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                            >
                ...
                <div className="mt-12 pt-8 border-t border-zinc-100 dark:border-zinc-800/80 flex flex-col sm:flex-row justify-between items-center gap-3">
                    <p className="text-xs text-zinc-400 dark:text-zinc-500 text-center sm:text-left">
                        ...
                        · perschat.my.id · Semua hak dilindungi undang-undang.
                    </p>
                    <p className="text-xs text-zinc-400 dark:text-zinc-500">
                        Dibuat dengan ❤️ oleh{" "}
                        <a
                            href="mailto:me@ozan.my.id"
                            className="font-medium text-zinc-500 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                        >
                            Ozan
                        </a>
                    </p>
